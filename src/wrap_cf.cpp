...
REF_FUNCTION_EX(sprite_get_frame, cf_sprite_current_frame);
REF_FUNCTION_EX(sprite_current_global_frame, cf_sprite_current_global_frame);
REF_FUNCTION_EX(sprite_get_global_frame, cf_sprite_current_global_frame);
...
REF_FUNCTION_EX(sprite_get_slice, cf_sprite_get_slice);
